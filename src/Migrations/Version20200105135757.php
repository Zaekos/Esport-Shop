 ...
 */
final class Version20200105135757 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vetement CHANGE created_at creation DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vetement CHANGE creation created_at DATETIME NOT NULL');
    }
}
